...
ifeq ($(PRODUCT_SUPPORT_EXFAT), y)
	...
	@sh tuxera_update.sh --target target/lg.d/sdm845 --use-cache --latest --max-cache-entries 2 --source-dir $(ANDROID_BUILD_TOP)/kernel/msm-4.9 --output-dir $(ANDROID_BUILD_TOP)/$(KERNEL_OUT) $(SUPPORT_EXFAT_TUXERA)
